        ...
        doLast {
          ...
          DriverManager.getConnection(extension.url, extension.user, extension.password)
            .use {
              ...
              var flywayLocation = "${Location.FILESYSTEM_PREFIX}${project.projectDir.absolutePath}/src/main/resources/db/migration"
              if (extension.externalFlywayLocations != null) {
                flywayLocation += ","
                flywayLocation += extension.externalFlywayLocations
              }
              ...
              val flywayConfig: Map<String, String> = mapOf(
                ...
                ConfigUtils.LOCATIONS to flywayLocation,
                  ...
                  Generator()
                    ...
                    .withDatabase(
                      Database()
                        ...
                        .also { database ->
                          extension.includeTables?.also {
                            database.withIncludes(it)
                          }
                          extension.excludeTables?.also {
                            database.withExcludes(it)
                          }
